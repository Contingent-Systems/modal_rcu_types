...
\tikzset{
  ...
  treenode/.style = {circle, draqw=black, align=center, minimum size=0.05cm},
...
\node[hollow node]          (kr)    [below right of = k]  {$H_2$};
    \node[hollow node]             (krl)         [below left of = kr]        {$H'_1$};
...
\tikzset{
  red node/.style = {rectangle,draw=red,inner sep=1.5, dashed},
  treenode/.style = {circle, draqw=black, align=center, minimum size=0.1cm},
  subtree/.style  = {draw,minimum size=0cm,inner sep=0,regular polygon,regular polygon sides=3},
  succn/.style = {circle,draw=purple,fill=purple,inner sep=0.2},
  blue node/.style = {rectangle,draw=blue,inner sep=1.5}
