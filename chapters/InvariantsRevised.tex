...
That is sixteen: twelve invariants, two rule defects, two model defects.  The
...
Twelve of the sixteen were found by attempting a proof rather than by reading ---
...
program ran into --- and seven of the twelve are cases the report calls
...
mirror lemma supplies.  What remains of the worked example is the concrete
instantiation --- the four-step chain with the tree's own numbers --- and the
one fact it asks of that tree, that the deleted node has a single predecessor,
is proved.
