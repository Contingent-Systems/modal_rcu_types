...
preserves \textbf{UNQR}, and a field write preserves \textbf{OW}, \textbf{HD},
\textbf{ULKR}, \textbf{FLR}, \textbf{FR} and \textbf{UNQRT}$_a$ under a side
condition apiece, each of which the rules already supply --- with the one
exception that produced the \textbf{FNR} repair above.  Unlinking and
...
being reachability, so it belongs with the path characterizations.
