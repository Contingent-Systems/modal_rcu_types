...
the \texttt{Print Assumptions} reports: all 338 say \emph{closed under the
...
One thing it does not claim is pool-level preservation of typing: one thread's
step changes shared state, and what says the others' environments survive it is
the framing property, which is where it already was.
