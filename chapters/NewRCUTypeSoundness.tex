...
\begin{enumerate}
    ...
    The instrumented execution states are also constrained by additional \textit{global} \textsf{WellFormed}ness \textit{invariants} -- see Appendix A.2 of the technical report~\cite{isotek} for detailed formal invariants -- the type system is intended to maintain, such as tree structure of the data structure.
...
\end{lemma}
\begin{proof}
In Appendix A.1 Lemma \ref{lemma:stblwap} of the technical report~\cite{isotek}.
\end{proof}
