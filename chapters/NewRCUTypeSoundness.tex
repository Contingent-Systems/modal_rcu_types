...
\mypar{Invariants of RCU Views and Denotations of Types}\label{sec:lemmas} Here we aim to convey the intuition behind the predicate \textsf{WellFormed} which enforces global invariants on logical states, and how it interacts with the denotations of types in key ways.
