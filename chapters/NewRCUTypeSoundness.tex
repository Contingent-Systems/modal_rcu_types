...
\mypar{General Invariant for Read Threads} All reader threads have to access to a valid heap location even during the \textit{grace-period}. \textsf{Readers-Iterators-Only} invariant asserts that a heap location can only be observed as \textsf{iterator} by the reader threads.
