...
\mypar{Acyclicity of Linked Data Structures} Additionally, our system ensures that none of the heap updating actions introduce \textit{acyclicity}.  -- \textsf{Unique-Reachable} invariant,  \textsf{Unique-Root} invariant and denotation $\llbracket \mathsf{rcuItr}\,\rho \,\N \rrbracket_{tid}$.
\subsection{Proof}
\label{sec:proof}
