...
\mypar{A General Invariant for Read Traversal} All reader threads have to access to a valid heap location even during the grace period. \textsf{Readers-Iterators-Only} invariant asserts that a heap location can only be observed as \textsf{iterator} by the reader threads.
