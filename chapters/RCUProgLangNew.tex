...
Reindexing the type environment of lines 23--24 yields the type environment of lines 19--20, making the types loop invariant. The reindexing essentially chooses a new value for the abstract $k$. This is sound, because the uses of framing in the type system ensure uses of any indexing variable are never separated -- either all are reindexed, or none are.
\looseness=-1
