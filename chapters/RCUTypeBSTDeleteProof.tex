    ...
    \;\;\{\\
        ...
        \;\;\;\;\specline{currentL:rcuItr\; (Left|Right)^{k}.(Left|Right).Left \; \{\} }\\
            ...
            \;\;\;\;if\; (parent.Left == current)\\
                \;\;\;\;\;\;\text{// parent.Value > current.Value, so make current's left child a left child of parent}\\
                \;\;\;\;\;\;\specline{parent:rcuItr\; (Left|Right)^{k} \; \{ Left \mapsto current\} }\\
            ...
            \;\;\;\;else \\
                ...
                \;\;\;\;\;\;\text{// parent.Value < current.Value, so make current's left child a right child of parent}\\
                \;\;\;\;\;\;\specline{parent:rcuItr\; (Left|Right)^{k} \; \{ Right \mapsto current\} }\\
    ...
    \;\;\{\\
        ...
        \;\;\;\;\specline{lmParent:rcuItr\; (Left|Right)^{k}.(Left|Right).Right \; \{ \} }\\
            ...
            \;\;\;\;if\; (parent.Left == current)\\
                ...
                \;\;\;\;\;\;\text{// parent.Value > current.Value, so make current's right child a left child of parent}\\
            ...
            \;\;\;\;else\\
                ...
                \;\;\;\;\;\;\text{// parent.Value < current.Value, so make current's right child a right child of parent}\\
