...
states each invariant in corrected form and records what changed and why.  Five
of the versions below --- \textbf{UNQR}, \textbf{RITR}, \textbf{FR},
\textbf{FPI} and \textbf{ULKR} --- are defective in ways that are machine
checked: vacuous, unsatisfiable, or too weak to support the uses the proofs make
of them.  They are retained here as the published statements; where a proof case
