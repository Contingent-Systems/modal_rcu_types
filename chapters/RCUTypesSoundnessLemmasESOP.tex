...
\label{ahu5flk} \\
\begin{aligned}
  \forall_{x \in \Gamma, \N_3, \rho_3,f_1,y} \ldotp (x:\textsf{rcuItr}\,\rho_3\,\N_3([f_1\rightharpoonup y])) \implies\left\{\begin{array}{l} (\neg\mathsf{MayAlias}(\rho_3,\{\rho_1,\rho_2\}) ) \arcr
...
\textsf{WellFormed}(\sigma',O'_{1},U'_{1},T'_{1},F'_1) \\
\label{phu11free}
\textsf{WellFormed}(\sigma',O'_{2},U'_{2},T'_{2},T'_2)
\end{gather}
