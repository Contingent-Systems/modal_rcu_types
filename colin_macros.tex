...
\infer[\textsc{#1}]{
  \Gamma\, G:\textsf{UniqueRoot}, y:\textsf{undef}  \vdash_{M,R}  y = G.f \dashv y:\textsf{rcuIterator} \underset{0}{\mid}, G : \textsf{UniqueRoot} \, \Gamma
}{
\begin{array}{c}
  \ftype
\qquad
  G \isolated \lor t'=\immutable\;\_
\\
...
\infer[\textsc{T-AssignVar}]{
  \Delta\mid x:\_, y : t  \vdash  x = y \dashv y : t, x : t  
}{
  t \neq \isolated\;\_
}
%\qquad
\\[0.5em]
\infer[\textsc{T-FieldWrite}]{
  \Delta\mid y : p\;T , x : t \vdash y.f = x \dashv y : p\;T , \consumeiso{x:t}
}{
  \Delta\vdash p \prec \writable 
\quad
  p\neq\isolated
\quad
  t\ f \in T
...
\\[0.5em]
\infer[\textsc{T-FieldConsume}]{
  y : \writable\;T \vdash x = \consume{y.f} \dashv y : \writable\;T,x : \isolated\;T_f
}{
  \isolated\ T_f\ f \in T
}
\qquad
\infer[\textsc{T-New}]{
  \Delta\mid x:\_\vdash x = \NEW\; T() \dashv x : \isolated\ T
}{
  \Delta\vdash T
}
\\[0.5em]
