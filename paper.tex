...
\newcommand{\rcuread}{\textsf{RCURead} \text{ x.f as y in }\, \{ C \}}
  \newcommand{\desugarread}{ \db{\rcuread}_{\;\;\Downarrow_{\mathrm{tid}}\;\;} \overset{\Delta}{=} \texttt{\textsf{ReadBegin}}; \{C\}  ;\textsf{ReadEnd} }
  \newcommand{\desugarwrite}{\db{\rcuwrite}_{\;\;\Downarrow_{\mathrm{tid}}\;\;} \overset{\Delta}{=} \texttt{\textsf{WriteBegin}} ; \{C\}  ;\textsf{WriteEnd}}
...
\input{chapters/Evaluation.tex}\raggedbottom
\input{chapters/NewRCUTypeSoundness.tex}\raggedbottom
%\input{chapters/NewRCUTypesRelatedWork.tex}\raggedbottom
